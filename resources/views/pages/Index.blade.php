    ...
    >
        ...
        <header class="mb-5 flex flex-col items-center">
            <a href="{{route('documentation.index')}}"
               ...
               role="alert">
                <span
                    class="text-xs bg-gradient-to-br from-green-500 to-blue-600 saturate-200 rounded-full text-white px-4 py-1.5 mr-3">Release!</span>
                <span class="text-sm font-medium">Socketeer 1.0 has been released</span>
